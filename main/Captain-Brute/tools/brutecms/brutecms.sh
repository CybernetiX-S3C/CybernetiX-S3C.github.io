#!/bin/bash
# BruteCMS v1.0.4
# Github: https://github.com/CybernetiX-S3C/brutecms
# Coded by: John Modcica @CybernetiX S3C (Don't change noob, read the LICENSE!)
...
printf "\n"
printf "\e[101m::\e[1;77m CMS BruteForcer coded by: John Modica @CybernetiX S3C ::\e[0m\n\n"
