...
HT_FOLDER="SK-WPS-Cracker$(date "+%T" | tr -d ":")"
...
echo ""
echo ""
echo -e "$White [${Green} ok ${White}]$Green SK-WPS Cracker$White By$BYellow John Modica @ CybernetiX-S3C."
echo ""
echo -e "$White [${Red} !! ${White}] Remove any temporary file."
rm -rf ${Temporary}
sleep 1
echo ""
echo -e "$White [${Red} ++ ${White}]$Green Thank You! ${Cyan}  John Modica${White} @${Cyan} CybernetiX-S3C${White} ."
echo ""
exit
}
exit_function() {
...
echo -e "$White [+]$Green Thank You! ${Cyan}John Modica${White} @${Cyan} CybernetiX-S3C${White} ."
echo -e "$DefaultColor"
exit
}
kill_wep_function() {
...
End_OF_THE_SCRIPT(){
					...
					echo -e "$White [${Red}+${White}]$Green Greetz to ${White}: ${Cyan}John Modica${White} @${Cyan} CybernetiX S3C${White} ."
					echo ""
					echo -e "             ${Green}########################################################################"
					sleep 0.1
					echo -e "             ##                           ${Yellow}{Full Information}${Green}                       ##"
					sleep 0.1
					echo -e "             ##   ${Cyan}-Author   ${White}:      {${Yellow} John Modica @ CybernetiX S3C  ${White}}               ${Green}##"
					sleep 0.1
					echo -e "             ##   ${Cyan}-Planet   ${White}:      {${Red} Earth ${White}                        }               ${Green}##"
					sleep 0.1
					echo -e "             ##   ${Cyan}-GitHub   ${White}:      {${Purple} www.github.com/Cybernetix-C3C ${White}}               ${Green}##"
					sleep 0.1
					echo -e "             ########################################################################"
					sleep 0.1
					echo -e "$DefaultColor"
...
echo -e $Yellow   "    |                                                                          |"
sleep 0.1
echo -e "     |$Green    _____________  __.          __      ____________  _________  _  _    $Yellow |"
sleep 0.1    
echo -e "     |$Green   /   _____/    |/ _|         /  \    /  \______   \/   _____/_| || |__ $Yellow |"   
sleep 0.1
echo -e "     |$BGreen   \_____  \|      <    ______ \   \/\/   /|     ___/\_____  \\    __   / $Yellow |"  
sleep 0.1 
echo -e "     |$BGreen   /        \    |  \  /_____/  \        / |    |    /        \|  ||  |  $Yellow |" 
sleep 0.1
echo -e "     |$Green  /_______  /____|__ \           \__/\  /  |____|   /_______  /_  ~~  _\ $Yellow |" 
sleep 0.1
echo -e "     |$Green          \/        \/                \/                    \/  |_||_|   $Yellow |"  
sleep 0.1
echo -e "     |$Cyan   _________                       __                                    $Yellow |"
sleep 0.1
echo -e "     |$BCyan   \_   ___ \____________    ____ |  | __ ___________                    $Yellow |"                   
sleep 0.1
echo -e "     |$Cyan   /    \  \/\_  __ \__  \ _/ ___\|  |/ // __ \_  __ \                   $Yellow |"                  
sleep 0.1
echo -e "     |$BCyan   \     \____|  | \// __ \\  \___|    <\  ___/|  | \/                    $Yellow |"
sleep 0.1
echo -e "     |$Cyan    \______  /|__|  (____  /\___  >__|_ \\___  >__|                       $Yellow |"
sleep 0.1
echo -e "     |$BCyan           \/            \/     \/     \/    \/                          $Yellow |"
sleep 0.1
echo -e $Cyan   "    +${Yellow}--------------------------------------------------------------------------${Cyan}+${Yellow}"
sleep 0.1
echo -e "                          |${BRed} Script${BYellow} Kiddie${BPurple} WPS${BGreen} Cracker${Yellow} |"
sleep 0.1
echo -e "                          ${Cyan}+${Yellow}---------------------------${Cyan}+"
sleep 0.1
Ver_User=`whoami`
if [ "$Ver_User" != "root" ]
	then
		...
		echo -e "${Yellow}     +${White}-------------------------------------------------------------------${Yellow}+"
		echo -e "${White}     | ${Red}                 \$${White}=> sudo ${Yellow}./${Green}SK${White}-${Green}WC${White}.${Green}sh${White}                              |"
		echo -e "${White}     | ${Red}                 \$${White}=> sudo ${Blue}bash ${Green}SK${White}-${Green}WC${White}.${Green}sh${White}                           |"
		echo -e "${Yellow}     +${White}-------------------------------------------------------------------${Yellow}+"
		echo ""
		echo ""
else
echo -e "$Yellow     +${White}--------------------------------------------------------------------------${Yellow}+"
echo -e "${White}     | ${Yellow} ID ${White} |                    ${BPurple}  Method To Choose                        ${White}     |"
echo -e "${Yellow}     +${White}--------------------------------------------------------------------------${Yellow}+"
...
echo -e "${White}     | ${Red}[${Yellow}04${Red}]${White} |$Green If you want to crack an access point's key with$BRed WPS PIN${White} .          |"
echo -e "${White}     | ${Red}[${Yellow}05${Red}]${White} |$Green If you want to crack a$BRed Hidden$Green access point${White} .                       |"
			  ...
			  "5")
                 ...
                 if [ "$VerMon" != "" ]
                      then
						   ...
						   Ver_Dir=`ls /tmp/SK-WPS-Cracker | grep -E '^capture$'`
						   if [ "$Ver_Dir" != "" ];then
	      			            rm -rf ${Temporary}/capture
								mkdir ${Temporary}/capture
						   else
